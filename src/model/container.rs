...
mod imp {
    ...
    pub(crate) struct Container {
        ...
        pub(super) volume_list: UnsyncOnceCell<model::SimpleVolumeList>,
        #[property(get)]
    ...
    impl Container {
        ...
        pub(super) fn volume_list(&self) -> model::SimpleVolumeList {
...
impl Container {
    ...
    where
        F: FnOnce(Result<model::Container, podman::Error>) + 'static,
    {
        let imp = self.imp();
